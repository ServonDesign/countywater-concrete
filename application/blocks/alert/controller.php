<?php
namespace Application\Block\Alert;
...
class Controller extends BlockController {
    protected $btTable = 'btAlert';
    protected $btName = "Alert";
    protected $btDescription = "Example of a block for Page Alert";
    protected $btDefaultSet = 'alert';

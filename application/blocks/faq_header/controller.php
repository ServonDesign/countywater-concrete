<?php
namespace Application\Block\FaqHeader;
...
class Controller extends BlockController {
    protected $btTable = 'btFaqHeader';
    protected $btName = "FaqHeader";
    protected $btDescription = "Example of a block for Page FaqHeader";
    protected $btDefaultSet = 'faq';

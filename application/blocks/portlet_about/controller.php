<?php
namespace Application\Block\PortletAbout;
...
class Controller extends BlockController {
    protected $btTable = 'btAboutPortlet';
    protected $btName = "AboutPortlet";
    protected $btDescription = "Example of a block for Page AboutPortlet";
    protected $btDefaultSet = 'aboutportlet';

<?php
namespace Application\Block\Basic;
...
class Controller extends BlockController {
    protected $btTable = 'btBasic';
    protected $btName = "Basic";
    protected $btDescription = "Example of a block with all the diffrent types of fields";

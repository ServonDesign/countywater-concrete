...
<h2>Contact Header Call Button</h2>



<div class="form-group">
    <label for="text" class="control-label">Contact Number</label>
    <input type="text" class="form-control" name="content" id="text" value="<?php echo $content; ?>">
</div>

<?php
namespace Application\Block\ContactHeader;
...
class Controller extends BlockController {
    protected $btTable = 'btContactHeader';
    protected $btName = "ContactHeader";
    protected $btDescription = "Example of a block for Page Contact Header";
    protected $btDefaultSet = 'contactheader';

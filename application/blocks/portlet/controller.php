<?php
namespace Application\Block\Portlet;
...
class Controller extends BlockController {
    protected $btTable = 'btPortlet';
    protected $btName = "Portlet";
    protected $btDescription = "Example of a block for Portlet";
    protected $btDefaultSet = 'portlet';

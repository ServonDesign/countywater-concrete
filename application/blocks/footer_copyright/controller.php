<?php
namespace Application\Block\FooterCopyright;
...
class Controller extends BlockController {
    protected $btTable = 'btFooterCopyright';
    protected $btName = "FooterCopyright";
    protected $btDescription = "Example of a block for Page FooterCopyright";
    protected $btDefaultSet = 'footercopyright';

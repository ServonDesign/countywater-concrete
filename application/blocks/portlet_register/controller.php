<?php
namespace Application\Block\PortletRegister;
...
class Controller extends BlockController {
    protected $btTable = 'btRegisterPortlet';
    protected $btName = "RegisterPortlet";
    protected $btDescription = "Example of a block for Page RegisterPortlet";
    protected $btDefaultSet = 'Registerportlet';

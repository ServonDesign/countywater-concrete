<?php
namespace Application\Block\PortletAuth;
...
class Controller extends BlockController {
    protected $btTable = 'btAuthPortlet';
    protected $btName = "AuthPortlet";
    protected $btDescription = "Example of a block for Page AuthPortlet";
    protected $btDefaultSet = 'authportlet';

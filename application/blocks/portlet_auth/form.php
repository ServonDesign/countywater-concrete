...
<h2>Portlet for Authentication</h2>


<div class="form-group">
    <label for="text" class="control-label">Registration Text</label>
    <input type="text" class="form-control" name="text" id="text" value="<?php echo $text; ?>">
</div>

<div class="form-group">
    <label for="text" class="control-label">Registration Link</label>
    <input type="text" class="form-control" name="registerlink" id="registerlink" value="<?php echo $registerlink; ?>">
</div>

<div class="form-group">
    <label for="text" class="control-label">Login Text</label>
    <input type="text" class="form-control" name="content" id="content" value="<?php echo $content; ?>">
</div>

<?php
namespace Application\Block\TestRepeating;
...
class Controller extends BlockController {
    ...
    protected $btTable = 'btTestRepeating';
    protected $btDataTableName = 'btTestRepeatingData';
    protected $btName = "TestRepeating";
    protected $btDescription = "Example of a repeating data block with all the diffrent types of fields";
    protected $btExportTables = array('btTestRepeating', 'btTestRepeatingData');

<?php
namespace Application\Block\PortletAccount;
...
class Controller extends BlockController {
    protected $btTable = 'btAccountPortlet';
    protected $btName = "AccountPortlet";
    protected $btDescription = "Example of a block for Page AccountPortlet";
    protected $btDefaultSet = 'accountportlet';

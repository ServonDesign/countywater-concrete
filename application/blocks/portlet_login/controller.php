<?php
namespace Application\Block\PortletLogin;
...
class Controller extends BlockController {
    protected $btTable = 'btLoginPortlet';
    protected $btName = "LoginPortlet";
    protected $btDescription = "Example of a block for Page LoginPortlet";
    protected $btDefaultSet = 'Loginportlet';

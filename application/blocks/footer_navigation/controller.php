<?php
namespace Application\Block\FooterNavigation;
...
class Controller extends BlockController {
    ...
    protected $btTable = 'btFooterNavigation';
    protected $btDataTableName = 'btFooterNavigationData';
    protected $btName = "FooterNavigation";
    protected $btDescription = "Example of a repeating data block with all the diffrent types of fields";
    protected $btExportTables = array('btFooterNavigation', 'btFooterNavigationData');
